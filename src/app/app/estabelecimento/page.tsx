    ...
    <main className="min-h-screen bg-muted/30 text-foreground">
      ...
      <section className="mx-auto grid max-w-6xl gap-5 px-5 py-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ["Perfil", "Revise os dados do estabelecimento.", Building2],
            ["Vagas", "Publique e gerencie oportunidades.", ClipboardList],
            ["Candidatos", "Aceite ou recuse candidaturas.", UsersRound],
